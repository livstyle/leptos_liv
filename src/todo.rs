...
pub fn TodoApp() -> impl IntoView {
    ...
    view! {
        <div class="w-full ml-10">
            ...
            <Stylesheet id="leptos" href="/pkg/leptos_liv.css"/>
            <Router>
                <header>
                    <A href="/">
                        <h1 class="p-6 text-4xl">"My Tasks"</h1>
                    </A>
    ...
    view! {
        <div class="w-full ml-10">
            <MultiActionForm action=add_todo>
                <label class="mr-2">"Add a Todo" <input class="border border-gray-800" type="text" name="title"/></label>
                <input type="submit" class="cursor-pointer bg-sky-200 hover:bg-sky-500 rounded-md" value="Add" />
            </MultiActionForm>
